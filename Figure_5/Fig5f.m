...
% conn_inf: Correlation of stimulus and action decoders, averaged across all visual-motor ROI pairs.
% conn_inf: Correlation of stimulus and action decoders, averaged across all auditory-motor ROI pairs. Here the stimulus decoder was trained and projected onto auditory cortex (as a control)

%% compare and plot 
figure

conn = conn_inf-conn_audi_inf;
